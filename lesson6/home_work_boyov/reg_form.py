...
def phone_format(phone_str):
    ...
    if len(phone_num) >= 9:
        ...
        return False, f'{phone_str} НЕВЕРНЫЙ ФОРМАТ ТЕЛЕФОНА'
...
def check_password(pwd):
    ...
    if len(pwd) < 8:
        ...
        return False, 'КОРОТКИЙ ПАРОЛЬ'  #возвращает кортеж. второй єлемент будет использоваться в Lesson6(импортирую модуль)
